...
class CIO4WC_DB {
    ...
    public static function update_customer( $user_id, $customer_data ) {
        ...
        $currentObject = maybe_unserialize( get_user_meta( $user_id, $cio4wc->settings['chargeio_db_location'], true ) );
        ...
        // Add to the database
        return update_user_meta( $user_id, $cio4wc->settings['chargeio_db_location'], $newObject );
    }
